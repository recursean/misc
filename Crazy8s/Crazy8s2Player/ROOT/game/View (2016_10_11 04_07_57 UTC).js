...
//View.prototype.block = function(blocked){
    var blockHandler = function(event){
	event.stopPropagation();
    };
View.prototype.blockUser = function(){
	var block = document.getElementById("block");
	block.setAttribute("style","opacity:0.5");
	var message = document.getElementById("message");
	message.setAttribute("style", "display:block");
	block.addEventListener("click", blockHandler, true);
};
View.prototype.unBlockUser = function(){
	var block = document.getElementById("block");
	block.setAttribute("style", "opacity:1.0");
	var message = document.getElementById("message");
	message.setAttribute("style", "display:none");
	block.removeEventListener("click",blockHandler, true);
    };
