...
View.prototype.announceHumanWinner = function() {
    ...
    window.location.assign("../Crazy8s?game=" + this.presenter.game + "&win=Y&cardsPlayed=" + this.presenter.cardCounter);
};
...
View.prototype.announceComputerWinner = function() {
    ...
    window.location.assign("../Crazy8s?game=" + this.presenter.game + "&win=N&cardsPlayed=" + this.presenter.cardCounter);
};
